...
class BabboNatale(arcade.Window):
    def __init__(self, larghezza, altezza, titolo):
        ...
        self.suono_munch = arcade.load_sound("/home/lello/python/Immagini-suoni/munch.mp3")
        self.background = arcade.load_texture("/home/lello/python/Immagini-suoni/Sfondo.png")
        self.score = 0
        self.score_text = arcade.Text("Score: 0", 10, 20, arcade.color.BLACK, 14)
    ...
    def setup(self):
        self.babbo = arcade.Sprite("/home/lello/python/Immagini-suoni/babbo.png")
    ...
    def crea_cookie(self):
        self.cookie = arcade.Sprite("/home/lello/python/Immagini-suoni/cookie.png")
    ...
    def on_key_press(self, tasto, modificatori):
        ...
        elif tasto in (arcade.key.M, arcade.key.M):
            self.suono_munch = False
